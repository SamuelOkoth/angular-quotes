...
var QuoteComponent = /** @class */ (function () {
    function QuoteComponent() {
        ...
        this.title = "QUOTES";
        this.quotes = [
            new _quote__WEBPACK_IMPORTED_MODULE_1__["Quote"](1, 'Samuel', 'Luther', 'Twenty years from now you will be more disappointed by the things that you didn’t do than by the ones you did do', new Date(2019, 7, 8), 0, 0),
            new _quote__WEBPACK_IMPORTED_MODULE_1__["Quote"](1, '', 'Einsten', 'Two things are infinite: the universe and human stupidity; and Im not sure about the universe', new Date(2019, 7, 8), 0, 0),
        ];
    }
...
module.exports = __webpack_require__(/*! /home/moringa/angular-quotes/src/main.ts */"./src/main.ts");
